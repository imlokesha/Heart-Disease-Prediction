...
Original file is located at
    https://colab.research.google.com/drive/1fvs_99FkVBt_b_yO7SYsZlkbpwnZwZJW?authuser=1
"""
...
# The above code is using the PyDrive library in Python to authenticate a user, set up Google
# credentials, and access Google Drive. It is authenticating the user, setting up Google credentials,
# and creating a connection to Google Drive using the PyDrive library.
auth.authenticate_user()
gauth = GoogleAuth()
gauth.credentials = GoogleCredentials.get_application_default()
drive = GoogleDrive(gauth)

link = 'https://drive.google.com/file/d/1UFn1aY4wEPhw2Jbq8GGB_AymhZIqb01o/view'
